...
const reach_us = document.getElementById('reach_us');
...
function toggleDarkLightMode(themeMode) {
    ...
    footer.style.backgroundColor = themeMode == LIGHT_THEME ? 'rgb(255 255 255 / 50%)' : 'rgb(0 0 0 / 30%)';
    reach_us.style.color = themeMode == LIGHT_THEME ? 'rgba(5, 3, 58, 1)' : 'rgba(255, 219, 23, 1)';
...
function darkMode() {
    ...
    footer.style.backgroundColor = 'rgb(0 0 0 / 30%)';
    reach_us.style.color = 'rgba(255, 219, 23, 1)';
...
function lightMode() {
    ...
    reach_us.style.color = 'rgba(5, 3, 58, 1)';
